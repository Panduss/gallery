...
var FirestoreBatchUnit = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.validate(op.item, op.collectionMetadata.entityConstructor)];
                    case 2:
                        errors = _b.sent();
                        if (errors.length) {
                            throw errors;
    ...
    FirestoreBatchUnit.prototype.add = function (type, item, ref, collectionMetadata, validateModels) {
    ...
    FirestoreBatchUnit.prototype.validate = function (item, Entity) {
