...
import { IEntity, IQueryBuilder, IWherePropParam, IFirestoreVal, IFireOrmQueryLine, IOrderByParams, IRepository, PartialBy, IEntityConstructor, ITransactionReferenceStorage } from './types';
